			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>Vibha Shekar N S</p>
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>Admin</p>
				    <p class="card-text">Last Login: 4 minutes ago</p>
				  </div>
				</div>
			</div>
			<div class="col-md-8">
		...
		<div class="row">
			<div class="col-md-4">
				<div class="card">
						...
						<p class="card-text">Here you add new parent and sub categories.</p>
